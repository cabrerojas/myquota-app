...
- Modificaste la estructura de módulos → skill-audit detecta que expo-module y expo-routes deben actualizarse
- Cambiaste la validación de env vars → skill-audit sugiere actualizar AGENTS.md y expo-auth
- Agregaste un nuevo flujo (ej: notificaciones) → skill-audit alerta que falta crear skill `expo-notifications`
