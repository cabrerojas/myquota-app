...
type NativeDateTimePicker =
  typeof import("@react-native-community/datetimepicker").default;
type WebDateInputStyle = ComponentProps<"input">["style"];
...
const webDateInputStyle = {
  ...
  fontSize: 15,
} as unknown as WebDateInputStyle;
...
function parseDateLocal(dateStr: string): Date {
  ...
  const chileDateStr = d.toLocaleDateString("es-CL", {
...
export default function BillingPeriodFormModal({
  ...
  const [DateTimePickerComponent, setDateTimePickerComponent] =
    useState<NativeDateTimePicker | null>(null);
  ...
  useEffect(() => {
    ...
    void import("@react-native-community/datetimepicker").then((module) => {
      setDateTimePickerComponent(() => module.default);
    });
  }, []);
  ...
  useEffect(() => {
    if (initialData) {
      ...
      if (initialData.startDate)
        setStartDate(parseDateLocal(initialData.startDate));
  ...
  const onDateChange =
    (setter: (d: Date) => void, showSetter: (v: boolean) => void) =>
              ...
              <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
                ...
                <View style={s.header}>
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    {isFirstTime && <Text style={s.stepHint}>Paso 2 de 2</Text>}
                  </View>
                  <Pressable
                    onPress={onClose}
                    style={({ pressed }) => [
                ...
                {isOrphanSuggestion && orphanedCount > 0 && (
                  <View style={s.alertBox}>
                    ...
                    <Text style={s.alertText}>
                      <Text style={s.alertBold}>
                        {orphanedCount} transacciones
                      </Text>{" "}
                      sin período asignado. Completá el formulario para
                      organizarlas.
                    </Text>
                  </View>
                )}
                ...
                <View style={s.buttonRow}>
                  ...
                  <Pressable
                    ...
                    style={({ pressed }) => [
                      s.btn,
                      s.btnSubmit,
                      (isSubmitting || !month.trim()) && { opacity: 0.5 },
      ...
      <View style={is.infoCards}>
        <View style={is.infoCard}>
          ...
          <View style={is.infoText}>
            ...
            <Text style={is.infoDesc}>
              Es el rango de fechas que cubre cada estado de cuenta de tu
              tarjeta.
            </Text>
          </View>
        </View>
        <View style={is.infoCard}>
          ...
          <View style={is.infoText}>
            ...
            <Text style={is.infoDesc}>
              Agrupa transacciones por mes para ver proyecciones y estadísticas.
            </Text>
          </View>
        </View>
        <View style={is.infoCard}>
          ...
          <View style={is.infoText}>
            ...
            <Text style={is.infoDesc}>
              MyQuota te avisará antes del cierre y vencimiento de cada período.
            </Text>
          </View>
        </View>
      </View>
